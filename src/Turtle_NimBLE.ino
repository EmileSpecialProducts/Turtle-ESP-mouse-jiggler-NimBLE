 ...
 * The old ESP32 does not support BLE only Bluetooth 4.2 so is not supported by this library.
 * you can used the https://github.com/EmileSpecialProducts/Turtle-ESP-mouse-jiggler
 *
                             Supported    BLE    USB
ESP32                        No           No    No
ESP32-S2                     Yes          No     Yes
ESP32-S3                     Yes          Yes    Yes
ESP32-C2/ESP8684(H2/H4)      Notyet#2     Yes    No
ESP32-C3                     YES          Yes    No
ESP32-C5                     Notyet#2     Yes    Yes
ESP32-C6                     Notyet#1     Yes    No
ESP32-C61                    Notyet#2     Yes    No
ESP32-H2                     Notyet#1     Yes    No
ESP32-P4                     No           No     No
ESP8266                      No           No     No

  *Notyet#1 is not supported by Arduino NimBLE 2024-09
  *Notyet#2 is not yet supported as i do not have the Chip or Platform software 2024-09
...
#if defined(CONFIG_BT_BLE_ENABLED)
  bleMouse.deviceName=strTurtleNameBLE;
  bleMouse.deviceManufacturer=strTurtleManufacturer;
  bleMouse.begin();
#endif
#if defined(CONFIG_TINYUSB_ENABLED)
  UsbMouse.begin();
